...
int main()
{
    while(1)
    {
        ...
        printf("Vă rugăm să introduceți numărul de producții\n");
        scanf("%d",&n);
        pro=n;
        char input[10*n][20],temp[20];
        term[0]='\0';
        printf("Vă rugăm să introduceți producțiile una câte una\n");
        printf("Pentru a intra într-o producție utilizați convențiile de tip: S->AabB\n");
        printf("Pentru a introduce o producție epsilon utilizați convenția de tip: S->\n");
        printf("Continuă, te rog\n");
        term[0]='\0';
        for(i=0;i<n;i++)
        {
            scanf("%s",input[i]);
        ...
        //Verificați dacă este un CFG. Și verificați și Gramatica.
        ...
        if(flag==1)
        {
            printf("\n\nHei Haide!!! Gramatica nu este nici macar un CFG!! Ce ar trebui să fac?");
            printf("Vrei sa faci asta din nou??\n");
            printf("Dacă da, tastați y. Orice altceva va fi considerat un nu.\n");
            scanf("%c",&k);
            scanf("%c",&k);
            printf("\n\n");
            if(k=='y')
        ...
        printf("\nVă rugăm să introduceți simbolul de pornire\n");
        scanf("%c",&k);
        while(1)
        {
            scanf("%c",&k);
        ...
        //Ambiguitate Verificați și eliminați.
        ...
        if(flag==0)
        {
            printf("Fără ambiguitate\n");
        }
        else
        {
            printf("\n\nProducțiile după eliminarea ambiguității sunt:\n");
            for(i=0;i<pro;i++)
            {
                printf("%s\n",input[i]);
            }
        ...
        //Verificați recursiunea stângă aici.
        ...
        if(flagger==0)
        {
            printf("Gramatica nu avea recursivitate lăsată\n");
        }
        else
        {
            ...
            printf("Producțiile după eliminarea recursiunii stângi sunt:\n");
            for(i=0;i<pro;i++)
            {
                printf("%s\n",input[i]);
            }
        ...
        if(flag==1)
        {
            ...
            printf("Gramatica mobilată după factoring stânga este:\n");
        }
        else
        {
            printf("Gramatica este deja luată în considerare\n\n");
            printf("Cu toate acestea, gramatica finală este:\n");
        }
        for(i=0;i<pro;i++)
        {
            printf("%s\n",input[i]);
        ...
        //Follow Computation.
            ...
            ////Unele preprocesare înainte de calcul Follow.
        ...
        printf("Următoarele dintre toate non-terminele sunt:\n");
        for(i=0;i<26;i++)
        {
            if(strlen(fol[i]))
            {
        ...
        //Realizarea tabelului de analiză.
        //Mai întâi, o mulțime de preprocesare.
        ...
        //Imprimarea tabelului parser așa cum este în caiet.
        //Verificați dacă este sau nu o gramatică LL1.
        flag=0;
        sub = 157;
        for(i=0;i<26;i++)
        {
        ...
        if(flag==0)
        {
            printf("\nGramatica este o gramatică LL(1).r\n\n");
        }
        else
        {
            printf("\nGramatica nu este o gramatică LL(1).\n\n");
        }
        printf("\n\nDeci tabelul de analiză arată astfel:\n\n");
        int max[terl];
        for(i=0;i<terl;i++)
        {
            max[i]=3;
        ...
        if(flag==0)
        {
            ...
            printf("\nDeoarece gramatica este LL(1), vom face acum analizatorul și câteva șiruri și vom vedea dacă funcționează corect.\n\n");
            while(1)
            {
                //Preluarea intrării șirului. Preprocesarea șirului.
                char str[1000];
                printf("\nIntroduceți șirul de intrare\n");
                scanf("%s",str);
                sub=36;
                temp[0]=sub;
                temp[1]='\0';
                ...
                if(flag==1)
                {
                    printf("\nGramatica dată nu generează acest șir\n");
                }
                else
                {
                    printf("\nȘirul este acceptat.\n");
                ...
                printf("\n\nDoriți să faceți acest lucru din nou cu un șir de intrare nou??\n");
                printf("Dacă da, tastați y. Orice altceva va fi considerat un nu.\n");
                scanf("%c",&k);
                scanf("%c",&k);
                printf("\n\n");
        ...
        printf("\n\nVrei să faci asta din nou cu o nouă gramatică??\n");
        printf("Dacă da, tastați y. Orice altceva va fi considerat un nu.\n");
        scanf("%c",&k);
        scanf("%c",&k);
        printf("\n\n");
